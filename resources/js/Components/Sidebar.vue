<template>
    <div id="sidebar" :class="{ '-translate-x-full': isHidden, 'translate-x-0': !isHidden }"
        ...
        <div class="w-full h-[calc(100%-4.5rem)] flex flex-col gap-4 items-center overflow-auto">
            ...
            <p v-if="$page.props.auth.user.roles && $page.props.auth.user.roles.length > 0 && ($page.props.auth.user.roles[0].role_name == 'super-admin' || $page.props.auth.user.roles[0].role_name == 'admin')"
                class=" text-center w-10/12 border-b border-gris-borde pb-2 mt-3 text-xl">Panel Administracion</p>
            <Link
                v-if="$page.props.auth.user.roles && $page.props.auth.user.roles.length > 0 && ($page.props.auth.user.roles[0].role_name == 'super-admin' || $page.props.auth.user.roles[0].role_name == 'admin')"
                :href="route('showUsers')" class=" button_nav ">
            <div class="h-6 w-6">
            ...
            <Link
                v-if="$page.props.auth.user.roles && $page.props.auth.user.roles.length > 0 && ($page.props.auth.user.roles[0].role_name == 'super-admin' || $page.props.auth.user.roles[0].role_name == 'admin')"
                :href="route('alertas')" class="button_nav">
            <div class="h-6 w-6">
            ...
            <Link
                v-if="$page.props.auth.user.roles && $page.props.auth.user.roles.length > 0 && ($page.props.auth.user.roles[0].role_name == 'super-admin' || $page.props.auth.user.roles[0].role_name == 'admin')"
                :href="route('showFichajes')" class=" button_nav ">
            <div class="h-6 w-6">
                <img class="h-full w-full" src="/img/sidebar/fichajes.png" alt="">
            </div>
            ...
            <Link
                v-if="$page.props.auth.user.roles && $page.props.auth.user.roles.length > 0 && ($page.props.auth.user.roles[0].role_name == 'super-admin' || $page.props.auth.user.roles[0].role_name == 'admin')"
                :href="route('horarios')" class=" button_nav ">
            <div class="h-6 w-6">
